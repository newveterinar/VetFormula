...
class PharmacyCRIResultFragmentViewModel: BaseViewModel<AppState>() {
    /** Исходные данные */ //region
    // LiveData
    private val liveDataForViewToObserve: LiveData<AppState> = _mutableLiveData
    // Интерактор
    private val interactor: PharmacyCRIResultInteractorImpl =
        PharmacyCRIResultInteractorImpl(this)
    //endregion
