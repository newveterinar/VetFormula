...
class GasInhalationAnasthesiaResultFragmentInteractorImpl(
    private val viewModel: GasInhalationAnasthesiaResultFragmentViewModel
): Interactor<AppState> {
    ...
    override suspend fun saveData(
        ...
        settings.getFormula().getTypedFormulas().forEachIndexed { index, typedFormula ->
            ...
            val outputDataDimensionType: OutputDataDimensionType = when(index) {
                0 -> OutputDataDimensionType.RATE
