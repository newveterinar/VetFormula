...
class FragmentScope {
    companion object{
        ...
        const val SHOW_GAS_INHALATION_ANASTHESIA_FRAGMENT_SCOPE =
            "SHOW_GAS_INHALATION_ANASTHESIA_FRAGMENT_SCOPE"
        const val SHOW_GAS_INHALATION_ANASTHESIA_RESULT_FRAGMENT_SCOPE =
            "SHOW_GAS_INHALATION_ANASTHESIA_RESULT_FRAGMENT_SCOPE"
        ...
        const val SHOW_ABOUT_CALC_SCOPE = "SHOW_ABOUT_CALC_SCOPE"
        const val SHOW_ABOUT_TIMER_SCOPE = "SHOW_ABOUT_TIMER_SCOPE"
    }
}
...
const val GASES_INHALATION_ANESTHESIA_SEVOFLURANE_INDEX = 0
const val GASES_INHALATION_ANESTHESIA_ISOFLURANE_INDEX = 1
const val GASES_INHALATION_ANESTHESIA_DESFLURANE_INDEX = 2
